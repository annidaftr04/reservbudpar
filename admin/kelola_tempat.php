...
<head>
    ...
    <style>
        ...
        .nav-link {
            ...
            padding: 14px 1rem; color: var(--muted-gray); text-decoration: none;
        ...
        .page-header {
            ...
            box-shadow: 0 10px 30px rgba(0,0,0,0.02); margin-bottom: 3rem;
        }

        .header-title h1 {
            font-weight: 800; font-size: 2.1rem; letter-spacing: -1.2px; margin-bottom: 4px; color: var(--dark);
        }
        ...
        .card-img-wrapper { position: relative; height: 210px; overflow: hidden; background: #e2e8f0; }
        .card-img-wrapper img { width: 100%; height: 100%; object-fit: cover; transition: transform 0.6s ease; }
        .place-card:hover .card-img-wrapper img { transform: scale(1.08); }

        /* Kategori Penanda Khusus Otomatis Sesuai Naskah Penelitian */
        .card-top-badge {
            position: absolute; top: 15px; left: 15px;
            background: rgba(15, 23, 42, 0.75); backdrop-filter: blur(8px);
            -webkit-backdrop-filter: blur(8px); color: white; font-size: 11px;
            font-weight: 700; padding: 5px 14px; border-radius: 50px; text-transform: uppercase;
        }

        .card-body-content { padding: 1.5rem; flex-grow: 1; display: flex; flex-direction: column; }
        .place-name { font-weight: 800; font-size: 1.25rem; color: var(--dark); margin-bottom: 6px; letter-spacing: -0.5px; }
        
        .place-loc {
            font-size: 0.85rem; color: #64748b; display: flex; align-items: center;
            gap: 6px; margin-bottom: 14px; font-weight: 600;
        }
        ...
        .card-action-bar {
            display: flex; border-top: 1px solid #f1f5f9; background: #fafafa; padding: 10px 1.5rem; gap: 10px;
        }

        .control-btn {
            flex: 1; padding: 9px; border-radius: 12px; font-size: 0.82rem;
            font-weight: 700; text-decoration: none; display: inline-flex;
            align-items: center; justify-content: center; gap: 6px; transition: 0.2s; border: none;
        }

        .btn-view-md { background: rgba(67, 97, 238, 0.08); color: var(--primary); }
        .btn-view-md:hover { background: var(--primary); color: white; }

        .btn-edit-md { background: rgba(16, 185, 129, 0.08); color: #10b981; }
        .btn-edit-md:hover { background: #10b981; color: white; }

        .btn-delete-md { background: rgba(239, 68, 68, 0.08); color: #ef4444; }
        .btn-delete-md:hover { background: #ef4444; color: white; }
        ...
        .btn-add-modern {
            ...
            box-shadow: 0 10px 20px rgba(67, 97, 238, 0.2); transition: 0.3s;
        }
        .btn-add-modern:hover { transform: translateY(-2px); background: var(--secondary); color: white; }

        /* Minimalist Rounded Pagination */
        .pagination-container { margin-top: 4rem; display: flex; justify-content: center; }
        .page-link {
            border: none; background: white; margin: 0 4px; border-radius: 12px;
            color: var(--dark); font-weight: 700; width: 42px; height: 42px;
            display: flex; align-items: center; justify-content: center;
            box-shadow: 0 4px 10px rgba(0,0,0,0.02); transition: 0.2s;
        }
        .page-link:hover { background: #e2e8f0; }
        .active .page-link { background: var(--primary) !important; color: white !important; }
