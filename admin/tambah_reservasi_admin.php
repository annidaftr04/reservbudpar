...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['hari'])) {
    ...
    $sumber_reservasi = 'offline';

    // ambil dari URL/database baru
    $place_id_fix = $_POST['tempat'] ?? null;
    $sub_place_id_fix = $_POST['sub_place_id'] ?? null;
...
<body>
    ...
    <div class="container main-container">
        <div class="glass-card">
            <div class="sidebar-info">
                ...
                <?= build_calendar_custom($month, $year, $booked_dates, $selected_date); ?>
                ...
                <div class="mt-5 pt-4 border-top border-white border-opacity-10">
                    ...
                    <div id="subPlaceWrapper"
                        ...
                        <select
                            ...
                            <?php
                            $subPlaces = $conn->query("
                                    SELECT id, nama_subtempat
                                    FROM sub_places
                                    ORDER BY nama_subtempat
                                ");

                            while ($sp = $subPlaces->fetch_assoc()):
                            ?>
                                <option value="<?= $sp['id'] ?>">
                                    <?= $sp['nama_subtempat'] ?>
                                </option>
                ...
                <form method="POST" enctype="multipart/form-data" id="formRes">
                    ...
                    <div class="row g-4">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="nama" placeholder="Masukkan nama pemohon" required>
                        </div>
                        ...
                        <div class="col-md-12 mt-5">
                            ...
                            <div class="text-center">
                                <a href="kelola_reserv.php" class="text-muted fw-bold small text-decoration-none">
    ...
    <script>
        ...
        function handleLocationChange(val) {
            ...
            const subPlace =
                document.getElementById('subPlaceWrapper');

            if (val == '20') {

                subPlace.style.display = 'block';

            } else {

                subPlace.style.display = 'none';
