...
<head>
    ...
    <style>
        ...
        .form-control-neumorphism {
            width: 100%;
            padding: 15px 20px 15px 50px; /* Adjust padding-left for icon */
            border: none;
            border-radius: 12px;
            background: var(--bg-color);
        ...
        .btn-register-neumorphism:hover {
    ...
    <div class="register-container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" class="form-control-neumorphism" id="nama" name="nama" placeholder="Nama Lengkap" required>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn-register-neumorphism">Register</button>
        </form>
        <p class="mt-4">
            Sudah punya akun? <a href="login_admin.php" class="link-login">Login di sini</a>
        </p>
    </div>
