...
<head>
    ...
    <style>
        ...
        /* Sidebar Base */
        .sidebar {
            width: 280px; height: 100vh; background: white; position: fixed;
            border-right: 1px solid rgba(0,0,0,0.05); z-index: 1000; padding: 2rem 1rem;
        }

        .sidebar-brand {
            display: flex; align-items: center; gap: 12px; padding: 0 1rem 2rem;
            font-weight: 800; font-size: 1.4rem; color: var(--primary); letter-spacing: -1px;
        }

        .nav-link {
            display: flex; align-items: center; gap: 12px; padding: 12px 1rem;
        ...
        .luxury-dashboard-card {
            background: #ffffff; border-radius: 36px; padding: 2.5rem;
        ...
        .main-display-box {
            ...
            box-shadow: 0 16px 40px rgba(0,0,0,0.08); position: relative;
        }
        .main-display-box img { width: 100%; height: 100%; object-fit: cover; transition: 0.3s; }
        ...
        .thumb-scroll-box {
            ...
            padding: 12px; margin-top: 1.25rem;
        }
        .thumb-grid { display: flex; gap: 10px; overflow-x: auto; padding-bottom: 4px; }
        .thumb-item {
            width: 90px; height: 65px; object-fit: cover; border-radius: 10px;
            cursor: pointer; transition: 0.2s; border: 3px solid transparent; flex-shrink: 0;
        }
        .thumb-item.active { border-color: var(--primary); box-shadow: 0 4px 10px rgba(67,97,238,0.15); }
        ...
        .info-header-badge {
            ...
            font-weight: 700; display: inline-flex; align-items: center; gap: 6px; margin-bottom: 1rem;
        }

        .info-title { font-weight: 800; font-size: 2.2rem; color: var(--dark); letter-spacing: -1px; margin-bottom: 1.5rem; }

        .section-label { font-size: 0.8rem; font-weight: 800; text-transform: uppercase; letter-spacing: 0.75px; color: var(--primary); margin-bottom: 0.5rem; }

        .desc-premium-box {
            background: rgba(15, 23, 42, 0.02); border-left: 4px solid var(--dark);
            padding: 1.5rem; border-radius: 0 16px 16px 0; color: #475569;
            line-height: 1.7; font-size: 0.95rem; margin-bottom: 1.5rem;
        }

        /* Sub Area Cards List */
        .sub-list-container { max-height: 250px; overflow-y: auto; padding-right: 5px; }
        .sub-inline-item {
            display: flex; align-items: center; gap: 15px; padding: 12px;
            background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 16px; margin-bottom: 10px;
        }
        .sub-inline-img { width: 65px; height: 50px; object-fit: cover; border-radius: 8px; }

        /* Buttons Grid */
        .actions-group { display: flex; gap: 12px; margin-top: auto; pt-3; }
        .btn-action { padding: 12px 24px; border-radius: 14px; font-weight: 700; font-size: 0.9rem; display: inline-flex; align-items: center; gap: 8px; text-decoration: none; transition: 0.2s; }
        .btn-act-primary { background: var(--primary); color: white; border: none; }
        .btn-act-primary:hover { background: var(--secondary); transform: translateY(-2px); box-shadow: 0 8px 20px rgba(67,97,238,0.2); color: white; }
        .btn-act-light { background: #f1f5f9; color: #475569; border: 1px solid #e2e8f0; }
        .btn-act-light:hover { background: #e2e8f0; color: var(--dark); transform: translateY(-2px); }

        @media (max-width: 1199px) {
            .main-content { padding: 1.5rem; }
            .main-display-box { height: 320px; }
        }
